...
class BASE_EXPORT ModuleCache {
 public:
  ...
  void AddNonNativeModule(std::shared_ptr<Module> module);

  void InjectModuleForTesting(std::shared_ptr<Module> module);
 ...
 private:
  ...
  static std::shared_ptr<Module> CreateModuleForAddress(uintptr_t address);
  ...
  std::vector<std::shared_ptr<Module>> native_modules_;
  ...
  std::vector<std::shared_ptr<Module>> non_native_modules_;
};
